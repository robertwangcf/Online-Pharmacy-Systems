...
String sql1 = "select * from TBLPAYMENTS where prscid=?";
...
String querytype = request.getParameter("tid");
...
<center><h2 style="color:green">Payment information</h2>
...
<%
  ...
  //query 1, for spring
    while(rs4.next()){
        ...
        String str4 = rs4.getString("prscid");
        String str5 = rs4.getString("amount");
        %>
        <table>
        <tr><td>
       <%out.println("The bill with ID: "+str4+" has been paid for "+str5+"dollars" );%>
        <br>
        </tr></td>
        <table>
       <%
